    ...
    <section class="bg-white py-8">
        ...
        <div class="container mx-auto flex items-center flex-wrap pt-4 pb-12">
            ...
            <div v-for="product in products" :key="product.id" class="w-full md:w-1/3 xl:w-1/4 p-6 flex flex-col">
                ...
                <router-link :to="{ name: 'product', params: { id: product.id } }"><button class="bg-blue-700 bg-opacity-40 hover:bg-[#230d8f] font-semibold w-full py-1.5 rounded mt-1.5 text-blue-800 hover:text-white transition-all duration-300">View Details</button></router-link>
            </div>
